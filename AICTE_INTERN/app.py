...
st.markdown("""
    <style>
        ...
        .stApp {
            background: linear-gradient(to right, #B7CFD2, #7E92AE);
        }
    </style>
...
# Image
st.image("ev_image.jpg", use_container_width=True)
...
st.markdown("Prepared for the AICTE Internship by Manusha")